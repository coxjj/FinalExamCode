...
public class Retirement {
	...
	{
		double top = TotalAmountSaved*(dAnnualReturnWorking/1200);
		double bottom = Math.pow((1+(dAnnualReturnWorking/1200)),12*iYearsToWork) -1;
		return Math.round(top*100.00/bottom)/100.00;
	}
